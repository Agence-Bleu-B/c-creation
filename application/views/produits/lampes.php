...
<div class="container">
  ...
  <section class="home_elmt row">
        ...
        <article class="col-md-3">
            <div class="accordion">
                <a href="<?php echo base_url('produits/lampes'); ?>" class="accordion-item accordion-item--default">
                    <h2>Lampes</h2>
        ...
        <article class="col-md-9">
            <h2 class="title_nouv"><a href="<?php echo base_url('produits/lampesP'); ?>"><i class="fa fa-th vignet" aria-hidden="true" ></i></a>Les Lampes</h2>
             <!-- Produits -->
           <div class="row">
