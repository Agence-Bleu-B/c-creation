  ...
  <section class="home_elmt row">
        ...
        <article class="col-md-3">
            <div class="accordion">
                ...
                <a href="<?php echo base_url('produits/ampoulesP'); ?>" class="accordion-item accordion-item--default">
                    <h2>Ampoules</h2>
                    <div class="accordion-item-content">
        ...
        <article class="col-md-9">
            <h2 class="title_nouv"><a href="<?php echo base_url('produits/ampoules'); ?>"><i class="fa fa-th-large vignet" aria-hidden="true" ></i></a>Les Ampoules</h2>
             <!-- Produits -->
        <div class="row">
